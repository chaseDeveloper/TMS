...
<%
	...
	String crfFile = (request.getParameter("crfFile") == ""   || request.getParameter("crfFile")   == null ? "" : request.getParameter("crfFile") );
	...
	System.out.println("crfFile>>>>>>>>>>>>>>>>>>>>  : "+ crfFile);
	OOFConnectionFile mc = oof.addConnectionFile("*", crfFile);
