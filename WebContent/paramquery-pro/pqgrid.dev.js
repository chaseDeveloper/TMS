...
"function" == typeof require ? (jQuery = require("jquery-ui-pack"), pq = {}, JSZip = require("jszip"), module.exports = pq) : (jQuery = window.jQuery, pq = window.pq = window.pq || {}, JSZip = window.JSZip), pq.mixin = {
	...
	var n, i, r, o, a, l, s, c, u, h, f, t = d.paramquery,
		...
		p = (e.find || (e.find = function(t, e) {
			...
			getFocusEle: function(t, e) {
				var n = ["a", "textarea", "button", "input", "select", "[tabindex]"].map(function(t) {
			...
			getFn: (a = {}, function(t) {
				var e = t;
				return pq.isStr(t) && !(e = a[t]) && (e = window, t.split(".").forEach(function(t) {
					e = e[t]
				}), a[t] = e), e
			}),
			isFn: function(t) {
			...
			makePopup: function(n, i, e) {
				...
				l.addClass("pq-popup").on("keydown", function(t) {
					t.keyCode != d.ui.keyCode.ESCAPE || t.isDefaultPrevented() || r(!0)
				}), d(i).one("remove", function() {
					r()
				}), requestAnimationFrame(function() {
					d(document).on(o, function(t) {
						var e = d(t.target);
						n.contains(e[0]) || pq.isCtrl(t) || e.closest(".ui-datepicker").length || e.closest(i).length && 9 != t.keyCode || r(!0)
					})
				})
			},
			...
			styleObj: function(e) {
				var n;
				return pq.isStr(e) && (n = e.split(";"), e = {}, n.forEach(function(t) {
	...
	var P = F.paramquery,
		...
		A = (e._createWidget = function(t, e) {
			...
			for (var t in this._trigger("destroy"), this._super(), F(window).off("resize" + this.eventNamespace), this) delete this[t];
			this.options = void 0, F.fragments = {}
	...
	A.setData = function(t) {
		...
		this.loading && this.xhr.abort(), this._destroyResizable(), this._destroyDraggable(), this.element.off(t), F(window).unbind(t), F(document).unbind(t), this.element.empty().css("height", "").css("width", "").removeClass("pq-grid ui-widget ui-widget-content ui-corner-all").removeData()
		...
		var t = this,
			...
			i = this.BS_on,
			r = n.collapsible;
		r.$stripe || (n = F(["<div class='pq-slider-icon pq-no-capture'  >", "</div>"].join("")).appendTo(e), r.$stripe = n), r.on ? r.$collapse || (r.$collapse = F(i ? o("collapse-down") : a("circle-triangle-n")).appendTo(r.$stripe).click(function() {
			...
			animate: !1
		}), r.toggle ? r.$toggle || (r.$toggle = F(i ? o("fullscreen") : a("arrow-4-diag")).prependTo(r.$stripe).click(function() {
			t.toggle()
		...
		e._mousePQUpDelegate = function(t) {
			F(document).unbind("mouseup" + e.eventNamespace, e._mousePQUpDelegate), e._trigger("mousePQUp", t, null)
		}, F(document).bind("mouseup" + e.eventNamespace, e._mousePQUpDelegate)
		...
		var r = this.options,
			...
			a = r.pageModel,
			r = r.dataModel;
		r.data = t.data, "remote" == a.type && (null != t.curPage && (a.curPage = t.curPage), null != t.totalRecords && (a.totalRecords = t.totalRecords)), this.hideLoading(), this._trigger("load", null, {
			dataModel: r,
			colModel: o
		...
		return (e ? [e] : ["attr", "cls", "style", "type", "options"]).forEach(function(t) {
			a[t] = n(a[t]) || ""
		}), e ? a[e] : a
		...
		if (0 != g) {
			...
			var w, t = (null == t.select ? p : t).select,
				...
				R = _,
				D = _,
				M = (h.cls = b, h.attr = q, "checkbox" == g ? (b = p.subtype, v.html(w = "<input " + (u ? "checked='checked'" : "") + " class='" + I + "' " + q + " " + D + " type=checkbox name='" + s + "' />"), D = v.children("input"), "triple" == b && (D.pqval({
					val: u
				}), v.click(function() {
					F(this).children("input").pqval({
						incr: !0
					})
				}))) : "textarea" == g || "select" == g || "textbox" == g || "contenteditable" == g ? ("textarea" == g ? w = "<textarea class='" + I + "' " + q + " " + R + " name='" + s + "' ></textarea>" : "contenteditable" == g ? (w = "<div contenteditable='true' dataType='" + (l.dataType || "") + "' " + _ + " " + q + " class='" + I + "' name='" + s + "'></div>", f = !0) : w = "select" == g ? (b = p.options || [], D = [q, " class='", I, "' ", R, " name='", s, "'"].join(""), P.select({
					options: b,
					attr: D,
					prepend: p.prepend,
					...
					dataMap: y
				})) : "<input class='" + I + "' " + q + " " + R + " type=text name='" + s + "' />", F(w).appendTo(v).val("select" == g && null != x && (C[x] || this.columns[x]) ? C[x] ? r[C[x]] : r[x] : u)) : g && F("<" + g + " class='" + I + "' tabindex=0 " + q + " " + R + ">").appendTo(v), h.$editor = v.children(".pq-editor-focus"), m = v.children(".pq-editor-focus"), o.filterKeys),
				_ = d.getCell(o.indices),
				b = l.editModel,
				T = (b && void 0 !== b.filterKeys && (M = b.filterKeys), "textarea" != g && "contenteditable" != g && _.empty(), {
					$cell: v,
					cellData: u,
					$editor: m,
					$td: _,
			...
			if (d._trigger("editorBegin", e, T), o.indices = T, (m = v.children(".pq-editor-focus")).data({
					...
					F(this).focus(), d._trigger("editorClick", null, T)
				...
				if (f) try {
					...
					k.selectNodeContents(m[0]), E.removeAllRanges(), E.addRange(k)
		...
		var e, n, i, r, o;
		t.cls && (e = this.getCellHeader(t), o = (n = (i = this._getHeadIndices(t.ri, t.colIndx)).column || {})[i = i.filterRow ? "clsFilter" : "clsHead"] || "", r = t.cls.split(" "), o = o.split(" ").filter(function(t) {
	...
	(N.paramquery.cKeyNav = function(e) {
		var n = this;

		function t(t) {
			e["$focusMgr" + t].on("focus", n["onFocus" + t].bind(n)).on("blur", n["onBlur" + t].bind(n))
		}
		n.that = e, t("Head"), t(""), e.on("headerKeyDown", n.headKeyDown.bind(n)), e.$focusMgr.on("keydown", function(t) {
			pq.isCtrl(t) && (n.ctrlKeyDown = !0)
		}).on("keyup", function(t) {
			n.ctrlKeyDown = !1
		}), e.options.editModel.pressToEdit && e.$focusMgr.on("input", n.onInput.bind(n))
	}).prototype = {
		...
		onFocus: function(t, e) {
			...
			var i, r, o = this.that,
				...
				d = o["$focusMgr" + l];
			2 == d.filter(":visible").length && (r = (t = d[0] == t) ? a ? {
				...
				colIndx: n(),
				ri: s
			}, e && null == s || a && null == r.rowIndxPage || null == r.colIndx ? ((e = N(d[t ? 1 : 0])).hide(), pq.focusEle(!t), e.show()) : (this["focus" + l](r), a && this.cSelect(r.rowIndxPage, r.colIndx)))
		},
		...
		onBlur: function(t, e) {
			var n = this,
				...
				a = n["ignoreBlur" + e],
				l = n.that;
			document.activeElement == i || a || (o && (n.removeClass(o, e), n[r] = null), l["$focusMgr" + e].show(), l._trigger("blur" + e, t, o))
		},
		focusHead: function(t) {
			this.focus(t, !0)
		},
		focus: function(t, e) {
			var n, i, r, o, a, l, s, d, c, u = this,
				h = u.that,
				f = !e,
				p = f ? "" : "Head",
				g = h["$focusMgr" + p],
				...
				x = 0,
				y = "ignoreBlur" + p,
				C = f ? h.pdata : h.iRenderHead.data,
				b = h.$cont,
				I = u[m];

			function q() {
				N(g[w]).hide(), i = g[x], (g = N(i)).show()
			}

			function _() {
				n = h[f ? "getCell" : "getCellHeader"](t), n = n[0], u.removeClass(I, p), t.cls = "pq-focus", h["addClass" + p](t), u[y] = !0, q(), n && (d = n.getBoundingClientRect(), s = g.parent()[0].getBoundingClientRect(), g.css({
					left: d.left - s.left,
					top: d.top - s.top
				}), c || u.scrollIntoView(i, d)), i.focus(), u[y] = !1, (I = u[m] = t).cell = n, h._trigger("focus" + p, null, I)
			}
			r = (t = t || {}).evt, c = t.noscroll, r || (f ? null != (o = null == (o = t.rowIndxPage) ? t.rowIndxPage = h.getFirstVisibleRIP(!0) : o) && (l = o + h.riOffset) : e && null == (l = t.ri) && (l = t.ri = C.length - 1), null != (a = t.colIndx) && -1 != a || (a = t.colIndx = h.getFirstVisibleCI(!0))), 0 <= l && 0 <= a ? (f && (u.isLastFocusableCell(t) && (w = 0, x = 1), v.ismergedCell(l, a) && (e = v.getRootCellO(l, a), o = t.rowIndxPage = e.rowIndxPage, a = t.colIndx = e.colIndx)), c ? _() : f ? h.scrollCell({
				rowIndxPage: o,
				colIndx: a
			}, _) : h.scrollColumn({
				colIndx: a
			}, _)) : r && (q(), u.removeClass(I, p), C = r.pageX, v = r.pageY, null != C && null != v && (l = b.offset(), g.css({
				left: C - l.left,
				top: v - l.top
			})), g.focus(), b.addClass("pq-focus"), I = u[m] = t, h._trigger("focus" + p, null, I))
		},
		removeClass: function(t, e) {
			var n = this.that;
			t && (t.evt ? n.$cont.removeClass("pq-focus") : n["removeClass" + e](t))
		},
		...
		headKeyDown: function(t, e) {
			...
			if (l) {
				...
				if (0 != r._trigger("beforeHeadKeyDown", t, l)) {
					if (i == g.ENTER) pq.isCtrl(t) ? (c = y.find(".pq-menu-icon,.pq-filter-icon")).length && c.click() : (c = y.find(".pq-icon-detail")).length ? c.click() : r.isSortable(p) ? ((l = N.Event("click")).shiftKey = t.shiftKey, y.find(".pq-title-span").trigger(l)) : p && (c = p.collapsible) ? (c.on = !c.on, r.refreshCM(), r.refresh(), I()) : (l = y.find("input,select,textarea")).length && l[0].focus();
					else if (i == g.SPACE) y.find("input").click();
					else if (b && x || C) {
						for (;;)
		...
		onInput: function(t) {
			var e, n, i = this.that,
				r = this.fe;
			!this.ctrlKeyDown && r && null != r.rowIndxPage && null != r.colIndx && (n = "select" == (e = i.getEditor(r, "type")), t = N(t.target), i.isEditable(r) && e && !n && (i.editCell(r), e = i.getEditCell().$editor, n = t.val(), e && e.val(n)), t.val(""))
		},
		bodyKeyDown: function(e) {
			...
			var l = this,
				...
				O = t(y.UP),
				V = t(y.DOWN);
			if (v.indices) s.$div_focus.find(".pq-cell-focus").focus();
			else {
				if (w && !p && T) return F = s.getViewPortIndx(), void s.focus({
					rowIndxPage: F.initV,
					colIndx: F.initH
				});
				if (f.hasClass("pq-focus-mgr")) {
					if (D && w) return !1;
					if (!f.is("select,input")) {
						...
						if (null != P && null != A && null != f) {
							if (h.ismergedCell(P, A) && (D = (F = p = h.getRootCellO(P, A)).rowIndxPage, P = F.rowIndx, A = F.colIndx, (M || $ || _ || R) && (F = h.getData(P, A, "proxy_cell")) && !w[h = F.rowIndx - d].pq_hidden && (P = (D = h) + d), g[A].hidden && (A = s.getNextVisibleCI(A))), 0 == s._trigger("beforeCellKeyDown", e, p)) return !1;
							s._trigger("cellKeyDown", e, p), _ || x && C ? (x && _ && (P = r() + d), A = (u ? i : n)(), l.select(P, A, e), S = !0) : R || x && b ? (x && R && (P = o() + d), A = (u ? n : i)(), l.select(P, A, e), S = !0) : C || b || O || V || m.onTab && I ? ((C && !u || b && u) && A != n() || H ? k = l.incrIndx(D, A, !1) : (b && !u || C && u) && (A != i() || c.autoAddCol) || T ? (!I && c.autoAddCol && A == i() && s.Columns().add([{}]), T && A == i() && (f.pq_detail || {}).show ? pq.focusEle(null, f.pq_detail.child) && (a(), S = !0) : !(k = l.incrIndx(D, A, !0)) && I && (w = s.parent(), F = pq.getFocusEle(), w && w.widget()[0].contains(F) && (h = w.Detail().getRip(s.widget().closest(".pq-detail")[0]), (k = w.KeyNav().incrIndx(h, w.getLastVisibleCI(), !0)) && (w.focus(k), w.KeyNav().cSelect(k.rowIndxPage, k.colIndx), S = !(k = null))))) : O ? (k = x ? {
								rowIndxPage: r(),
								colIndx: A
							} : l.incrRowIndx(D, A, !1)).rowIndxPage == D && (l.focusHead({
								colIndx: A
							}), a(), k = null) : V && (k = x ? {
								rowIndxPage: o(),
								colIndx: A
							} : (c.autoAddRow && D == o() && s.addNodes([{}]), l.incrRowIndx(D, A, !0))), k ? (P = k.rowIndxPage + d, l.select(P, k.colIndx, e)) : null == S && I && (a(), S = !1), null == S && (S = !0)) : $ || M ? (s.iRenderB[M ? "pageUp" : "pageDown"](D, function(t) {
								P = t + d, l.select(P, A, e)
							}), S = !0) : q == y.ENTER ? ((E = s.getCell(p)) && E[0] && (s.isEditable(p) ? s.editCell(p) : (g = E.find("button,input[type='radio']"))[0] && N(g[0]).click()), S = !0) : x && "65" == q ? (_ = s.iSelection, "row" == m.type && "single" != m.mode ? s.iRows.toggleAll({
								all: m.all
							}) : "cell" == m.type && "single" != m.mode && _.selectAll({
								type: "cell",
								all: m.all
							}), S = !0) : x ? S = !1 : v.pressToEdit && this.isEditKey(q) && !x && (46 == q ? s.clear() : ("select" == s.getEditor(p, "type") && (D = p.rowIndxPage, A = p.colIndx, (E = s.getCell(p)) && E[0] && s.isEditable(p) && s.editCell({
								rowIndxPage: D,
								colIndx: A,
								select: !0
		...
		getValText: function(t) {
			var t = t[0].nodeName.toLowerCase(),
				e = "text";
			return e = -1 != N.inArray(t, ["input", "textarea", "select"]) ? "val" : e
		},
		...
		keyPressInEdit: function(t, e) {
			var n = this.that,
				...
				o = o.dataType;
			if (0 <= N.inArray(t.keyCode, l)) return !0;
			if (!1 === n._trigger("editorKeyPress", t, N.extend({}, r))) return !1;
		...
		keyUpInEdit: function(t, e) {
			var n = this.that,
				...
				i = i.editModel,
				r = i.indices;
			n._trigger("editorKeyUp", t, N.extend({}, r));
			var o, n = r.column.dataType;
			!e || "float" != n && "integer" != n || (r = N(t.target), e = "integer" == n ? i.reInt : i.reFloat, t = this.getValText(r), i = r.data("oldVal"), o = r[t](), 0 == e.test(o) && "=" !== o[0] && (e.test(i) ? r[t](i) : (o = ("float" == n ? parseFloat : parseInt)(i), isNaN(o) ? r[t](0) : r[t](o))))
		},
		...
		select: function(o, a, l) {
			...
			s.scrollCell({
				...
				l.shiftKey && l.keyCode !== N.ui.keyCode.TAB && u.type && "single" != u.mode && (r.length || h) ? h ? s.iRows.extend({
					rowIndx: o,
					evt: l
	...
	(t.paramquery.cGenerateView = function() {}).prototype = {
		...
		renderCell: function(t) {
			var e, n, i, r, o, a, l = this.that,
				...
				_ = u.freezeCols,
				R = u.columnBorders;
			if (f) return o = f[g], c || (C && d.push(x(C)), b && d.push(x(b)), (C = (f.pq_cellstyle || {})[g]) && d.push(x(C)), w == _ - 1 && R && h.push("pq-last-frozen-col"), p.cls && h.push(p.cls), u.editModel.addDisableCls && !1 === l.isEditable(t) && h.push("pq-cell-disable"), v ? o = !o || "data" != o.substr(0, 4) && "http" != o.substr(0, 4) ? o : '<img style="max-height:100%;max-width:100%;" src = "' + o + '" />' : pq.isStr(o) && "html" != m && (o = pq.escapeHtml(o))), b = u.format.call(l, f, p, I, q), C = b ? this.format(o, b, m) : o, t.dataIndx = g, t.cellData = o, t.formatVal = C, (w = p.render) && (a = l.callFn(w, t)) && "string" != typeof a && ((e = a.attr) && s.push(y(e)), r = a.prop, (i = a.cls) && h.push(i), (n = a.style) && d.push(x(n)), a = a.text), (a = null == a && (w = p._renderG || p._render) ? w.call(l, t) : a) && "string" != typeof a && ((e = a.attr) && s.push(e), (i = a.cls) && h.push(i), (n = a.style) && d.push(x(n)), a = a.text), null == a && (a = C || o), c ? [a, n, r, (e || {}).title] : ((_ = (r = r || {}).align || I.align || q.align || p.align) && h.push("pq-align-" + _), (_ = r.valign || I.valign || q.valign || p.valign) && h.push("pq-valign-" + _), (R = (f.pq_cellcls || {})[g]) && h.push(R), (u = (f.pq_cellattr || {})[g]) && s.push(y(u, d)), d = d.length ? " style='" + d.join("") + "' " : "", null == (a = pq.newLine(a)) && (a = ""), ["<div class='", h.join(" "), "' ", s.join(" "), d, " >", v ? a : "<div>" + a + "</div>", "</div>"].join(""))
		}
	}
}(jQuery), ! function(h) {
	var n, t = h.paramquery,
	...
	e.getHeadCell = function(t) {
		...
		onHeaderCellClick: function(t, e, n) {
			...
			!1 !== a._trigger("headerCellClick", n, {
				...
				colIndx: e,
				dataIndx: c
			}) && -1 != e && (l.column && l.type && !d.hasClass("pq-title-span") && !d.hasClass("ui-icon") ? (l = {
				c1: e,
				firstC: e,
	...
	w.paramquery.mixHeaderFilter = {
		...
		getControlStr: function(t) {
			var e = this.that,
				...
				u = l.style || "",
				l = (l.attr || "") + " tabindex=-1";
			return s && 0 <= s.indexOf("textbox") ? (o = o || "", c = c + " pq-search-txt" + r, d = "textbox2" == s ? this.betweenTmpl(this._input(t, o, c + " pq-from", u, l, i), this._input(t, a, c + " pq-to", u, l, i)) : this._input(t, o, c, u, l, i)) : "select" === s ? d = "<input type='text' " + ["name='", n, "' class='", c += r, "' style='", u, "' ", l].join("") + " ><span style='position:absolute;" + (e.options.rtl ? "left" : "right") + ":3px;top:6px;' class='ui-icon ui-icon-arrowthick-1-s'></span>" : "checkbox" == s ? d = ["<input ", null == o || 0 == o ? "" : "checked=checked", " name='", n, "' type=checkbox class='" + c + "' style='" + u + "' " + l + " />"].join("") : pq.isStr(s) && (d = s), d
		},
		renderFilterCell: function(t, e, n) {
			var i, r = this.that.options,
				...
				a = t.cls,
				l = t.halign || t.align;
			return l && n.push("pq-align-" + l), a && n.push(a), n.push(t.clsFilter), t.filter ? (i = this.getControlStr(t)) && n.push("pq-col-" + e) : r.showHeader || "detail" != t.type || (i = this.getTitle(t, e)), (l = this.hasMenu(o, t)) && n.push("pq-has-menu"), ["<div class='pq-td-div' style='overflow:hidden;'>", "", i, "</div>", l ? "<span class='pq-filter-icon'></span>" : ""].join("")
		},
	...
	v.extend(u, {
		...
		refresh: function(t) {
			...
			t.colModel && i.refreshCM(), l[0].offsetWidth ? (t.toolbar && i.refreshToolbar(), (e = i.options).collapsible._collapsed = !1, n.setMax("maxHeight"), n.setMax("maxWidth"), n.refreshGridWidthAndHeight(), a && !1 !== o && i._refreshPager(), d.htCenter = n.setCenterHeight(), o = s[0].offsetWidth, d.wdCenter = d.wdGrid - o, i.$grid_center.css("margin" + (e.rtl || "left" == (e.sideBar || {}).align ? "Left" : "Right"), o), i.iRenderB.init({
				header: r,
				soft: t.soft,
				source: t.source
	...
	F.widget("paramquery.pqToolbar", {
		...
		_create: function() {
			...
			for (d.addClass("pq-toolbar"); c < u; c++) {
				var h, f, p, g, m = s[c],
					...
					q = m.cls,
					q = q || "",
					q = (q = o && "button" == v ? r.btn + " " + q : q) ? "class='" + q + "'" : "",
					_ = m.style,
					_ = _ ? "style='" + _ + "'" : "",
					R = m.attr || "",
					D = C ? "<label " + _ + ">" + C : "",
					M = C ? "</label>" : "",
					T = (T = C && "button" != v && "file" != v ? [q, R] : [q, R, _]).join(" ");
				m.options = y, "textbox" == v ? g = F([D, "<input type='text' " + T + ">", M].join("")) : "textarea" == v ? g = F([D, "<textarea " + T + "></textarea>", M].join("")) : "select" == v ? (pq.isFn(y) && (y = y.call(n, {
					colModel: a
				})), f = P.select({
					options: y = y || [],
					attr: T,
				...
				}), g = F([D, f, M].join(""))) : "file" == v ? g = F(["<label class='ui-button ui-widget ui-state-default ui-corner-all " + (q = x && C ? "ui-button-text-icon-primary" : x ? "ui-button-icon-only" : "ui-button-text-only") + "' " + R + " " + _ + ">", "<input type='file' style='display:none;' " + (m.attrFile || "") + ">", x ? "<span class='ui-button-icon-primary ui-icon " + x + "'></span>" : "", "<span class='ui-button-text'>" + (C || "") + "</span>", "</label>"].join("")) : "checkbox" == v ? g = F([C ? "<label " + _ + ">" : "", "<input type='checkbox' ", w ? "checked='checked' " : "", T, ">", C ? C + "</label>" : ""].join("")) : "separator" == v ? g = F("<span class='pq-separator' " + [R, _].join(" ") + "></span>") : "button" == v ? (g = F("<button type='button' " + T + ">" + (o ? x ? "<span class='glyphicon " + x + "'></span>" : "" : "") + C + "</button>"), F.extend(y, {
					label: C || !1,
					icon: x,
					icons: {
						primary: o ? "" : x
					}
				}), g.button(y)) : pq.isStr(v) ? g = F(v) : pq.isFn(v) && (f = v.call(n, {
					colModel: a,
					cls: q
				}), g = F(f)), g.appendTo(d), b && b.call(n, g[0]), p = this.getInner(g, C, v), "checkbox" !== v && void 0 !== w && p.val(w);
				for (var S = 0, k = I.length; S < k; S++) {
					var E = {};
					for (t in "function" == typeof(h = I[S]) ? E[i[v]] = h : E = h, E) pq.fakeEvent(p, t, l), p.on(t, this._onEvent(n, E[t], m))
				}
			}
		}
	}), F.extend(P.pqToolbar.prototype, {
		getInner: function(t, e, n) {
			var i = t[0];
			return "LABEL" == i.nodeName.toUpperCase() ? F(i.children[0]) : t
		},
		refresh: function() {
		...
		_onEvent: function(n, i, r) {
			return function(t) {
				var e = r.type;
				r.value = "checkbox" == e ? F(t.target).prop("checked") : F(t.target).val(), i.call(n, t), "file" == e && F(this).val("")
			}
		},
		_destroy: function() {
	...
	var r = null,
		...
		j = (B.extend(e.options, {
			...
			paste: function(e) {
				...
				r = new j(this), null == e.text && t && t.readText ? t.readText().then(function(t) {
					e.text = t, n()
				}).catch(function(t) {
					n()
				}) : n()
		...
		a = (j.clip = "", j.prototype = {
			...
			paste: function(t) {
				...
				if (i && i.val(""), l.on && 0 != t.length && 0 != o) {
					for (var u = 0; u < o; u++) r[u] = r[u].split("\t");
		...
		}, B(document).unbind(".pqExcel").bind("keydown.pqExcel", function(t) {
			if (pq.isCtrl(t)) {
				var e = B(t.target);
				if (e.hasClass("pq-focus-mgr")) {
					...
					if (r || e.length && n.length) {
						...
						"67" == t.keyCode || "99" == t.keyCode ? r.copy({
							...
							cut: !0,
							clip: e
						}) : "86" != t.keyCode && "118" != t.keyCode || (o = !0, window.setTimeout(function() {
							r && (r.paste({
								clip: e
							}), r = null), o = !1
						}, 3))
				...
				var n = t.keyCode,
					i = B.ui.keyCode;
				if (n == i.UP || n == i.DOWN || n == i.LEFT || n == i.RIGHT || n == i.PAGE_UP || n == i.PAGE_DOWN) {
					if (a) return !1;
					((e = B(t.target)).hasClass("pq-grid-row") || e.hasClass("pq-grid-cell")) && (a = !0)
				}
			}
		}).bind("keyup.pqExcel", function(t) {
			var e = t.keyCode;
			o || !r || pq.isCtrl(t) || -1 == B.inArray(e, [17, 91, 93, 224]) || (r = null), !a || (e = B(t.target)).hasClass("pq-grid-row") || e.hasClass("pq-grid-cell") || (a = !1)
		}), !1)
}(jQuery), ! function(a) {
	var t = a.paramquery,
		...
		t = (pq.filter = {
			...
			rangeInit: function(t) {
				...
				e || a.parent().off("click keydown").on("click keydown", function(t) {
					...
					"keydown" == t.type && t.keyCode != n.DOWN && t.keyCode != n.ENTER || (t.preventDefault(), n = i.uuid + "_" + o.dataIndx, c("#" + n).length || (t = new pq.cFilterMenu.select(i, o), e = (n = c("<div id='" + n + "' style='width:270px;' class='pq-theme'><div></div></div>").appendTo(r ? i.$header : document.body)).children(), pq.makePopup(n[0], a), n.position({
						my: "left top",
						at: "left bottom",
						of: a
					}), t.create(e, l), n.on("remove", function() {
						a.focus()
					}), pq.focusEle(null, n)))
				})
			},
		...
		x = (t.pqGrid.prototype.sort = function(t) {
			...
			saveOrder: function(t) {
				...
				var e = this.that.get_p_data(),
					n = e.find(function(t) {
						return !t.pq_gtitle && !t.pq_gsummary
					});
				if (n && null == n[t] || !n)
	...
	m.beforeTrigger = function(e, n) {
		...
		init: function() {
			var t, e, n, i, r = this;
			r.onCMInit(), r._init || (r.mc = [], r.summaryData = [], t = (e = (i = r.that).options).groupModel, e = e.bootstrap.on, r.groupRemoveIcon = "pq-group-remove " + (n = e ? "glyphicon " : "ui-icon ") + (e ? "glyphicon-remove" : "ui-icon-close"), r.toggleIcon = "pq-group-toggle " + n, i.on("cellClick", r.onCellClick(r)).on("cellKeyDown", r.onCellKeyDown2(r, t)).on(!0, "cellMouseDown", r.onCellMouseDown()).on("change", r.onChange(r, t)).on("dataReady", r.onDataReady.bind(r)).on("beforeFilterDone", function() {
				r.saveState()
			}).on("columnDragDone", r.onColumnDrag(r)).on("colMove", r.onColMove.bind(r)).on("customSort cancelSort", r.onCustomSort.bind(r)).on("valChange", r.onCheckbox(r, t)).on("refresh refreshRow", r.onRefresh(r, t)).on("refreshHeader", r.onRefreshHeader.bind(r)), (t.titleIndx || t.titleInFirstCol) && i.on("CMInit", r.onCMInit.bind(r)), i.on("beforeCheck", r.onBeforeCheck.bind(r)), r.setCascadeInit(!0), r._init = !0)
		},
	...
	n.prototype = {
		...
		importS: function(t, e, n, i, r) {
			...
			for (null != r && (T = r + 1, u = _[r], _ = _.slice(T), R = 0 < (R -= T) ? R : 0), D = 0, o = _.length; D < o; D++) l = (a = _[D]).indx || D, h = (s = {}).pq_cellprop = {}, f = s.pq_cellstyle = {}, p = s.pq_cellattr = {}, g = s.pq_rowstyle = {}, m = s.pq_rowprop = {}, y.copyStyle(a, m, g), l != D && y.fillRows(C, l, !0), (a.cells || []).forEach(function(t, e) {
				d = t.indx || e, c = i && S && M[d] ? M[d].dataIndx : d, s[c] = t.value, v = h[c] = {}, w = f[c] = {}, y.copyStyle(t, v, w), (v = t.comment) && (p[c] = {
					title: v
				}), t.format && y.copyFormat(s, c, t.format), (w = t.formula) && y.copyFormula(s, c, T ? k(w, 0, -T) : w), q <= d && (q = d + 1)
	...
	pq.excelImport = {
		...
		cacheStyles: function() {
			...
			t.find("numFmts>numFmt").each(function(t, e) {
				...
				e.each(function(t, e) {
					var n = g(e),
						i = n.children()[0];
					i && (n = n.attr("style"), r[e.tagName] = (n == o ? "3px" : "1px") + " " + (n == o ? o : "solid") + " " + (s.colorFromNode(i) || "#000000"))
				}), p.push(r)
				...
				e.find("b").length && (o.bold = !0), (r = r && s.colorFromNode(r)) && (o.color = r), i && i.toUpperCase() != l && (o.font = i), n && n != a && (o.fontSize = n), e.find("u").length && (o.underline = !0), e.find("i").length && (o.italic = !0), h.push(o)
		...
		getWorkSheet: function(t, e, n, i, r) {
			...
			for (e.forEach(function(t, e) {
				...
				for (o in l = {
						cells: []
					}, m = T[k], w = (h = C.attr(m)).r, h.customHeight && (l.htFix = 1.5 * h.ht), x = (s = h.s) ? C.getStyle(s) : {}) l[o] = x[o];
				(v = w ? w - 1 : k) !== k && (l.indx = v), h.hidden && (l.hidden = !0);
				for (var F, P = 0, A = (F = m.match(/(<c[^<]*?\/>|<c.*?<\/c>)/g) || []).length; P < A; P++) {
					if (u = F[P], d = (f = C.attr(u)).t, u = C.match(u, /<c.*?>(.*?)(<\/c>)?$/, 1), a = {}, "inlineStr" == d ? y = (y = u.match(/<t><!\[CDATA\[(.*?)\]\]><\/t>/)) ? y[1] : (y = u.match(/<t>(.*?)<\/t>/), pq.unescapeXml(y[1])) : null != (y = C.match(u, /<v>(.*?)<\/v>/, 1) || void 0) && (y = "s" == d ? n[y] : "str" == d ? pq.unescapeXml(y) : "b" == d ? "1" == y : R.VALUE(y)), (d = f.r) ? c = q(c = d.replace(/\d+/, "")) : (c = P, d = pq.toLetter(c) + (v + 1)), b[d] && (a.comment = b[d]), void 0 !== y && (a.value = y), c !== P && (a.indx = c), (d = _(u, v, c)) && (a.formula = pq.unescapeXml(d)), s = f.s, g = S[c], s = s && this.getStyle(s)) {
	...
	e.prototype = N.extend({
		...
		getXlsBody: function(t, e, n, i, r, o, a, $, H, l, s) {
			for (var d, c, u, h, f, p, g, m, v, w, x, y, C, b, I, q, _, R, D, M, T, S, k, E, F = this.that, O = F.options, P = [], V = L.cFormulas.shiftRC(F), A = 0; A < i; A++) {
				for (_ = (v = n[A]).pq_cellattr, M = v.pq_cellprop || {}, b = v.pq_rowprop || {}, S = v.pq_cellstyle || {}, m = [], h = {
						rowIndx: w = r ? A + o : A,
						rowIndxPage: w - o,
						rowData: v,
						Export: !0
					}, d = 0; d < e; d++) y = (q = t[d]).style, k = S[x = (C = q).dataIndx], T = M[x] || {}, c = R = v[x], u = F.getFormula(v, x), E = !1, (E = !a.ismergedCell(w, d) || a.isRootCell(w, d, "o") ? E : !0) || u || (h.colIndx = d, h.column = q, h.dataIndx = x, c = (E = this.getRenderVal(h, $, H))[0], f = E[1], g = E[2], p = E[3]), E = O.format.call(F, v, q, T, b), q = {}, pq.isStr(E) && (E = pq.isDateFormat(E) ? (c !== R && N.datepicker.formatDate(E, new Date(R)) === c && (c = R), pq.juiToExcel(E)) : (c !== R && pq.formatNumber(R, E) === c && (c = R), pq.numToExcel(E)), q.format = E), void 0 !== c && (q.value = c), _ && (R = _[x]) && ((D = R.title) && (q.comment = D), (D = R.style) && this.copyStyle(q, D)), this.copyStyle(q, k, T, y, C), this.copyStyle(q, f, g, y, C), p && (q.comment = p), u && (l && (u = V(u, 0, l)), q.formula = u), pq.isEmpty(q) || (q.dataIndx = x, m.length !== d && (q.indx = d), m.push(q));
				I = {}, m.length && (I.cells = m), v.pq_hidden && (I.hidden = !0), v.pq_htfix && (I.htFix = v.pq_ht), this.copyStyle(I, v.pq_rowstyle, b), s && (D = (s.call(F, h) || {}).style) && this.copyStyle(I, D), pq.isEmpty(I) || (P.length !== A && (I.indx = A), P.push(I))
			}
			return P
		},
	...
	var r, i = pq.excel = {
		...
		getStyle: function() {
			...
			if (w) {
				for (p in delete w.length, w) t = "<color " + ((a = p.split("_"))[0] ? 'rgb="' + this.getColor(a[0]) + '"' : 'theme="1"') + " />", n = '<name val="' + (a[1] || "Calibri") + '"/>', e = '<sz val="' + (a[2] || 11) + '"/>', i = a[3] ? "<b/>" : "", r = a[4] ? "<i/>" : "", o = a[5] ? "<u/>" : "", q.push("<font>", i, r, o, e, t, n, '<family val="2"/></font>');
				delete g.fonts
			}
			if (x) {
				for (p in delete x.length, x) {
					...
					_.push("<border>"), y.forEach(function(t) {
						D[t] && (a = D[t].split(" "), _.push("<" + t + ' style="' + ("1px" == a[0] ? "thin" : "double") + '"><color rgb="' + g.getColor(a[2]) + '"/></' + t + ">"))
					}), _.push("</border>")
				}
				delete g.borders
			}
	...
	pq.Select = function(t, e) {
		...
		pq.makePopup(n[0], e[0]), n.position({
			my: "left top",
			at: "left bottom",
			of: e,
			collision: "fit"
	...
	d(document).on("pqGrid:bootup", function(t, e) {
		...
		getMenuH: function(t, e) {
			return d.extend({}, t.menuUI, e.menuUI)
		},
		open: function(t, e, n) {
			var i, r, o = this,
				a = o.that,
				l = a.options,
				l = (e = e || a.getCellHeader({
					dataIndx: t
				}), t = null != t ? (i = a.columns[t], (o.menuH = o.getMenuH(l, i)).tabs) : ["hideCols"], o.$popup = d(o.getMenuHtml(t)).appendTo(document.body)),
				s = o.$tabs = l.find(".pq-tabs");
			return -1 < t.indexOf("hideCols") && (r = o.$grid = d("<div/>").appendTo(l.find("#tabs-hideCols")), o.grid = pq.grid(r, o.getGridObj())), -1 < t.indexOf("filter") && o.appendFilter(l.find("#tabs-filter"), i), pq.makePopup(o.$popup[0]), s.tabs({
				active: localStorage["pq-menu-tab"] || 1,
				activate: function(t, e) {
					localStorage["pq-menu-tab"] = d(this).tabs("option", "active"), d(e.newPanel).find(".pq-grid").pqGrid("refresh")
				}
			}), l.resizable({
				handles: "e,w",
				maxWidth: 600,
				...
				o.$popup = null, a.focusHead({
					...
					colIndx: a.colModel.indexOf(i)
				})
			}), pq.focusEle(null, l), this
		},
	...
	l.fn.val = function(t) {
		var e, n, i, r = this[0];
		return r && "true" == r.contentEditable ? arguments.length ? void(null != t && (r.innerHTML = pq.escapeHtml(t + "").replace(/\n/g, "<br>"), e = r, n = h(), i = f(), e.lastChild && (n.removeAllRanges(), i.setStartAfter(e.lastChild), n.addRange(i)))) : (e = (e = r.innerHTML).replace(/<br>/g, "\n"), l("<p>").html(e).text()) : o.apply(this, arguments)
	...
	pq.cRender = function() {
		...
		preInit: function(t) {
			var e = this,
				...
				r = e.that,
				o = r.options,
				a = "<textarea " + ("ontouchstart" in window ? "disabled" : "") + ' class="pq-focus-mgr"></textarea>',
				l = r.eventNamespace,
	...
	(pq.cRenderHead = function(t, e) {
		...
		getRowClsStyleAttr: function(t) {
			var e = this.that,
				n = e.headerCells.length,
				e = e.options.filterModel.header,
				i = "";
			return n == t || e && 1 == n ? i = "pq-grid-header-search-row" : t == n - 1 && (i = "pq-grid-title-row"), [i, "", ""]
		},
		getTblCls: function(t) {
